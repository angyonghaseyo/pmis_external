  ...
  const navItems = [
    ...
    },
    {
      ...
      accessRights: ['Create Cargo Booking', 'Create Facility Rental', 'View Cargo Manifests', 'Submit Cargo Manifest', 'Update Cargo Manifest', 'Delete Cargo Manifest',
        ...
        'Create Container Menu', 'View Container Menu', 'Register Truck', 'View Truck Registrations', 'View Container Requests', 'Approve Container Requests', 'Create Sampling Request', 'Create Repacking Request', 'Create Storage Request']
    },
    {
